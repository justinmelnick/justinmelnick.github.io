...
\begin{enumerate}
           \item Melnick, Justin and Alastair Smith. 2024. \href{https://justinmelnick.github.io/papers/paris/paper.pdf}{Shaming Paris: A Political Economy of Climate Commitments}. (conditionally accepted, \textit{International Organization})
...
\begin{enumerate}
            \item Melnick, Justin. 2024. \href{https://justinmelnick.github.io/papers/exit/paper.pdf}{Domestic Inequality, Heterogeneous Redistribution, and Exit from International Agreements}. (revise and resubmit, \textit{Journal of Theoretical Politics})
...
\begin{table}[!htbp]
    ...
    Harvard University (scheduled); Environmental Politics and Governance Conference (scheduled) & 2025\\
...
\begin{itemize}
\item Reviewer:  \textit{Journal of Conflict Resolution} (2x); \textit{Climatic Change}
